...
gomap<-read.table('wholetranscript/east_coast/go_bp__eastcoast.txt',sep='\t',quote="",comment.char="")
...
gomap<-read.table('wholetranscript/east_coast/go_mf__eastcoast.txt',sep='\t',quote="",comment.char="")
goannot<-read.table('all_GOterms_new.txt',sep='\t',quote="",comment.char="",header=TRUE)
goannot<-goannot[,1:3]
